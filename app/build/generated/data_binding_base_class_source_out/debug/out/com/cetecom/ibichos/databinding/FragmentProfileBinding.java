...
public final class FragmentProfileBinding implements ViewBinding {
  ...
  private FragmentProfileBinding(@NonNull ConstraintLayout rootView, @NonNull Button btnLogout,
      @NonNull ImageView ivAvatar, @NonNull TextView tvAvatarHint, @NonNull TextView tvLevel,
      @NonNull TextView tvUserEmail, @NonNull TextView tvUserName, @NonNull TextView tvXp) {
  ...
  public static FragmentProfileBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new FragmentProfileBinding((ConstraintLayout) rootView, btnLogout, ivAvatar,
          tvAvatarHint, tvLevel, tvUserEmail, tvUserName, tvXp);
    }
