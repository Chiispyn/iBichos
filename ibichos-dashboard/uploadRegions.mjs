...
const regionsWithComunas = {
    ...
    "Aysén del General Carlos Ibáñez del Campo": ["Coihaique", "Lago Verde", "Aysén", "Cisnes", "Guaitecas", "Cochrane", "O'Higgins", "Tortel", "Chile Chico", "Río Ibáñez"],
...
async function uploadLocations() {
  try {
    await setDoc(doc(db, "metadata", "locations"), {
        regions: regionsWithComunas
    });
    console.log("Successfully uploaded Chilean locations to metadata/locations!");
    process.exit(0);
  } catch (error) {
